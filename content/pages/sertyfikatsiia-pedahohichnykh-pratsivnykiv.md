...
blocks:
  ...
  - type: documents
    ...
    view: collapsed
    items:
      - label: Щодо деяких питань сертифікації у 2025 році
        children:
          - label: Лист
            url: https://drive.google.com/file/d/1Vs15NJb67iRjHIsU1lluMDHunDIQSN9S/view?usp=sharing
      - label: Щодо деяких питань сертифікації у 2024 році
        children:
          - label: Лист
            url: https://drive.google.com/file/d/1fGu_0e4HiaItKkON5B8p4EJXEMEHVYBy/view?usp=sharing
          - label: Наказ
      ...
      - label: Положення про сертифікацію педагогічних працівників
        url: https://docs.google.com/document/d/1PSW88wzOT3wMgXykpOx4etj409Qx7rco/edit?usp=sharing&ouid=104895709143078317433&rtpof=true&sd=true
      ...
      - label: Лист щодо сприяння експертам
        url: https://drive.google.com/file/d/1LiNcO-3wY0KH-QhBarUWkRg8yczBfTS2/view?usp=sharing
      - label: Список експертів Полтавської області
        url: https://docs.google.com/document/d/1h6aenbhPD_v_SyUs-DCv68ObciAroGJM/edit?usp=sharing&ouid=104895709143078317433&rtpof=true&sd=true
  - type: text
